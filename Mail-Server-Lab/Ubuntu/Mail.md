...
> **Ubuntu note:** This document is conceptual — it describes mail components, ports, and protocols in general terms, none of which are FreeBSD- or Ubuntu-specific. It's included here unchanged from the original lab. For Linux/Ubuntu file paths and commands, see the main `README.md` and `MailLog-Explanation.md` in this folder.
